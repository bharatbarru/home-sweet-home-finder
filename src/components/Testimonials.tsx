...
const testimonials = [
  {
    ...
    content:
      "Working with Prestige Estates was an absolute dream. They found us our perfect family home within weeks. Their attention to detail and understanding of our needs was remarkable.",
    rating: 5,
  },
  {
    id: 2,
    ...
    content:
      "As an investor, I've worked with many agencies. Prestige Estates stands out for their market expertise and professional approach. They've helped me build an impressive portfolio.",
    rating: 5,
  },
  {
    id: 3,
      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={testimonial.id}
              className="group bg-card rounded-2xl p-8 shadow-soft hover:shadow-elevated transition-all duration-500 border border-border/50 hover:border-gold/30 animate-fade-up relative"
